...
public class ZuoArrayList<E> extends AbstractList<E> implements List<E>,
	 ...
	 */
	public ZuoArrayList(int initialCapacity) {
		super();
	 ...
	 */
	public ZuoArrayList(Collection<? extends E> c) {
	...
	public void ensureCapacity(int minCapacity) {
		...
		if (minCapacity > oldCapacity) {
			...
			//System.out.println("enSure Capacity Called, new Capacity "+elementData.length+" copy time:"+(System.currentTimeMillis()-start));
		}
	}
	...
	public Object clone() {
		try {
			ZuoArrayList<E> v = (ZuoArrayList<E>) super.clone();
	 ...
	 * More formally, removes the element with the lowest index <tt>i</tt>
	 * such that
	 * <tt>(o==null&nbsp;?&nbsp;get(i)==null&nbsp;:&nbsp;o.equals(get(i)))</tt>
	 ...
	 * call shortens the list by <tt>(toIndex - fromIndex)</tt> elements. (If
